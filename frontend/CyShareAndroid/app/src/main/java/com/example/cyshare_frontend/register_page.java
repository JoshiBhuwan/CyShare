...
public class register_page extends AppCompatActivity {
    ...
    public void validate(RequestQueue vQueue, String email, String password1, String password2, String name) {
        ...
        // if passwords match and new email is being added
            ...
            if(userType == userTypes.DRIVER) {
                ...
                backend_io.serverPost(vQueue, url, to_server);
                to_driver_reg();
            }
            else{
                // creates json object and send to server
     ...
     */
    public JSONArray create_post_object(String email, String pass, String fullname, String role) {
    ...
    private void to_driver_reg(){
        Intent loadReg = new Intent(this, driver_reg.class);
