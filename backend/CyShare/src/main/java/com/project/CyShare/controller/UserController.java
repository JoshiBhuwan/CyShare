...
public class UserController {
     ...
     * @param userId ID for user to make changes.
    ...
    public String updateRole(@PathVariable long userId, @RequestBody Role role) throws Exception {
        if (role == null) {
            return "Error: role = null";
        }
        userService.findById(userId).setRole(role);
